...
> **Flatpak Firefox users**: native messaging is not currently supported in Flatpak-sandboxed Firefox due to an architectural sandbox restriction. See `Documentation/flatpak-firefox-native-messaging.md` for the full investigation and workarounds.
